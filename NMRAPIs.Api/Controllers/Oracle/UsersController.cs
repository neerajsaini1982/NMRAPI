// <copyright file="UsersController.cs" company="NMRAPIs">
...
namespace NMRAPIs.Api.Controllers.Oracle
{
    ...
    using NMRAPIs.BusinessLogic.Features.Oracle.User;
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IMediator mediator, IOptions<AzureAdSettings> azureSettings)
        {
