// <copyright file="EventsController.cs" company="NMRAPIs">
...
namespace NMRAPIs.Api.Controllers.Oracle
{
    ...
    public class EventsController : Controller
    {
        ...
        public EventsController(IMediator mediator, IOptions<AzureAdSettings> azureSettings)
        {
        ...
        [ProducesResponseType(typeof(ApiResponse<EventViewModel>), 200)]
        public async Task<IActionResult> GetEventById(int id)
        {
            ...
            return this.Ok(await this.mediator.Send(new GetEventByIdCommand() { EventId = id }));
        }
    }
}
