...
namespace NMRAPIs.BusinessLogic.Features.Profile
{
    ...
    public class GetAllUsersCommandCommandHandler : IGetAllEntityCommandHandler<GetAllUsersCommand, UserViewModel>
    {
        ...
        /// </summary>
        /// <param name="service">Instance of <see cref="IProfileService"/> service.</param>
        public GetAllUsersCommandCommandHandler(IProfileService service)
        {
